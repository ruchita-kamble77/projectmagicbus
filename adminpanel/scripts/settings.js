...
function upd_general(site_title_val,site_about_val)
  {
      ...
      xhr.onload =function(){
        ...
        if(this.responseText == 1)
        {
          ...
          alert('error',' no changes changes made!');
        }
        }
...
function upd_shutdown(val){
    let xhr = new XMLHttpRequest();
      ...
      xhr.onload =function(){
        ...
        {
          alert('success','site has been shut ShutDown!');
        }
        else{
...
function upd_contacts(){
    let index =['address','gmap','pn1','pn2','email','insta','fb','tw'];
    let contacts_inp_id = ['address_inp','gmap_inp','pn1_inp','pn2_inp','email_inp','insta_inp','fb_inp','tw_inp','iframe_inp'];
    ...
    let xhr = new XMLHttpRequest();
      ...
      xhr.onload =function(){
        ...
        if(this.responseText == 'inv_img'){
          ...
          alert('error','Images size should be less than 2MB !');
        }
